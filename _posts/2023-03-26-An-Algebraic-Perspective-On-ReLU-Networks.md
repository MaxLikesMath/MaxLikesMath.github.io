...
We can generalize this to any $$\land$$ between any number of input variables by $$\sigma(P \cdot x + (1-\text{||}P\text{||}_1 ))$$ where the logical statement $$P$$ is encoded by vector with entries of $$0$$s and $$1$$s.
